    ...
    <div className="bg-gray-800 text-white px-5 relative z-50">
      <section className="max-w-[1200px] mx-auto text-white">
        ...
        focus:outline-none focus:border-green-500 focus:ring-2
         focus:ring-green-500 bg-gray-800 border-gray-200 border-2"
                placeholder="Email"
              />
        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center py-6 border-t-2 border-gray-400">
            <span className="text-sm text-gray-400">
              copyright &copy; 2026 by Hassan Abd ElAziz.
            </span>
            ...
            <span className="text-sm text-shadow-gray-400">
